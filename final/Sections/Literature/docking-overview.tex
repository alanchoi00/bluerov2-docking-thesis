...
This illustrates the breadth of ROV-involved docking solutions, from launch and recovery systems to ROVs serving as docking stations for AUV support. Across these systems, the common structure is a two-phase mission: long-range homing followed by short-range terminal alignment. This thesis addresses the terminal phase.
