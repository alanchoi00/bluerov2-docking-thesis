...
% Part A adds the DYNAMICS half of the envelope: clean capture to 8 s sway periods,
% limited by vehicle bandwidth (240 ms plant lag), with capture-interface numbers
% (>= 0.15 m funnel radius, ~0.1 m/s closing speed) for the dock designer.
