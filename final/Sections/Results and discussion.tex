...
In the operational terms of Section~\ref{sec:method-sim}, each period
cell maps to a sea state and dock depth. The mean NSW sea (8~s period,
1.6~m significant height) forces a 0.1~m sway on a dock near 33~m depth,
which the baseline handles cleanly; the 6~s wind-sea cell corresponds to
a shallow dock near 19~m in the same sea, where the baseline still docks
in every trial under raw scoring; and the longer-period cells correspond
to deeper moorings reached only by swell, where both configurations
succeed. The measured envelope therefore covers moored docks across
typical continental-shelf operating depths, with residual risk
concentrated in shallow, short-period deployments, and the method's
cliff at 8 to 10~s sits at the region's mean wave period, which is
precisely why the baseline's structural immunity matters operationally.
